...
//projection{{{
		...
		hSigDeltaPhi2_fine->Divide(hBkgDeltaPhi2_fine);
		hSigDeltaPhi2_coarse->Divide(hBkgDeltaPhi2_coarse);
//}}}
...
//projection{{{
		...
		hSigDeltaPhi1p5_fine->Divide(hBkgDeltaPhi1p5_fine);
		hSigDeltaPhi1p5_coarse->Divide(hBkgDeltaPhi1p5_coarse);
//}}}
...
//projection{{{
		...
		hSigDeltaPhi1_fine->Divide(hBkgDeltaPhi1_fine);
		hSigDeltaPhi1_coarse->Divide(hBkgDeltaPhi1_coarse);
//}}}
